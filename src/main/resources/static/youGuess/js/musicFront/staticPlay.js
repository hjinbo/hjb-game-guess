    ...
    */
    ...
    function doubleClickPlay() {
        $(".playerDiv .playerList .song").dblclick(function() {
            ...
            $(".songOperator #start").css("background-position", "0 -42px");
            // 设置当前歌曲图片
            $(".player .songPic").css("background-image", "url(" + $(this).children(".songPic").text() + ")");
            // 设置最大时长
    ...
    function getStaticUrl(index) {
        var mUrlList = [
            "https://dl.stream.qqmusic.qq.com/C400003aAYrm3GE0Ac.m4a?vkey=1EF3DBD42AFC38225C427FFA16343958ECC76676B0FD62303424F27BFE222EE1B1AA4F5AD8EF14E720F52082635A24A34E657F9582AC5718&guid=746301965&uin=0&fromtag=38",
            "https://dl.stream.qqmusic.qq.com/C4000009BCJK1nRaad.m4a?vkey=E314701BE3D68138246268BD53639C159842A8D05686D0432170C585026FE23D8E92D724175E420DACA0CD7786735FA82A0A662406102480&guid=1839606061&uin=0&fromtag=38",
